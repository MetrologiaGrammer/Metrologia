					...
					<header id="header">
						...
						<nav>
							<ul>
                                ...
                                <li style="margin-right: 10px;" class=""><a href="https://arketipo.mx/Metrologia/inicio/editarEquipo.php" target="_blank" ><img class="zoom" style="width: 100%" alt="" src="https://arketipo.mx/Metrologia/pantallaInicio/imagen/editar.php"></a></li>
							</ul>
						</nav>
					</header>
				<!-- Footer -->
